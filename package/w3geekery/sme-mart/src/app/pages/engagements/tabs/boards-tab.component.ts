 ...
 *
 * NOTE (engagement -> projectId): boards are owned by platform.Project. The engagement
 * route id is passed as the `projectId` filter per Plan 32-02. Resolving a distinct
 * platform-project id for engagements (if their boards diverge from the engagement id)
